...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("tm12_ecbpi", package_name="tm12_ecbpi3_moveit_config")
        .to_moveit_configs()
    )

    # Configure robot_description
    description_path = 'tm_description'
    xacro_path = 'tm12_ecbpi3.urdf.xacro'
    moveit_config_path = 'tm12_ecbpi3_moveit_config'    
    srdf_path = 'config/tm12_ecbpi.srdf'
    ...
    print(trajectory_execution)
    print(moveit_controllers)
    print(planning_scene_monitor_parameters)
    ...
    # RViz configuration
    rviz_config_file = get_package_share_directory('tm_move_group') + rviz_path
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
